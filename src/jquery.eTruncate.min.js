...
{var self=this;self.version="1.0";var defaultOptions={elements:".more",createButton:true,buttonContainer:null,buttonCode:'<span><a href="#"></a></span>',showText:"More",showClass:"show",hideText:"Less",hideClass:"hide",startStatus:"hidden"};self.options=$.extend({},defaultOptions,options);self.container=container;self.container.data("eTruncate",self);var init=function()
